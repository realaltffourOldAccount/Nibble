...
void GEngine::MVP::updateModel(const glm::mat4 model) { _model = model; }

void GEngine::MVP::updateView(const glm::mat4 view) { _view = view; }

void GEngine::MVP::updateProj(const glm::mat4 proj) { _proj = proj; }
...
void GEngine::MVP::calc(void) { _mvp = _proj * _view * _model; }