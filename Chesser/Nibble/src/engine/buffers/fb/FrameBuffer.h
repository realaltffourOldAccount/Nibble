...
#ifndef BUFFER_FRAMEBUFFER_H
#define BUFFER_FRAMEBUFFER_H

#include <engine/shaders/Shaders.h>
#include <engine/textures/Texture.h>

#include "../ibo/IndexBufferObject.h"
#include "../rb/RenderBuffer.h"
#include "../vao/VertexArrayObject.h"
...
namespace GEngine {
    ...
    class FrameBuffer {
        public:
             ...
             * @return unsigned int
             */
            unsigned int GetTexture(void) { return this->mTex; }
